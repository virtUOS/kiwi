...
template = ("You are an intelligent and friendly assistant helping users with questions about the document. "
            ...
            "Overlake_intro|1-30: Overlake is the name of the area that includes a park and ride near Bellevue."
            "Overlake_intro|1-29: In-network institutions include Overlake, Swedish and others in the region"
            ""
            "Answer: "
            "In-network deductibles are $500 for employee and $1000 for family[D16-1229|1-32] and "
            "Overlake is in-network for the employee plan[Overlake_intro|1-31][Overlake_intro|1-29]."
            ""
            ""
            "###"
            "Question: '{question}'?"
